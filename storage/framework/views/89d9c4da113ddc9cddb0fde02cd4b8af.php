...
unset($__errorArgs, $__bag); ?>" id="height" name="height"
                   step="0.1" min= "0" value="<?php echo e(old('height', $user->height)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="weight" name="weight"
                   step="0.1" min= "0" value="<?php echo e(old('weight', $user->weight)); ?>">
...
unset($__errorArgs, $__bag); ?>" type="radio" id="male" name="gender" value="male" 
...
unset($__errorArgs, $__bag); ?>" type="radio" id="female" name="gender" value="female" 
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control <?php $__errorArgs = ['goal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="goal" 
                      name="goal"><?php echo e(old('goal', $user-> goal)); ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\tomis\Desktop\Marko\Faks\BPIO\aplikacija_za_fitness\resources\views/users/edit.blade.php ENDPATH**/ ?>